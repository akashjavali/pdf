...
var _FontDescriptor = require('./FontDescriptor');

var _FontDescriptor2 = _interopRequireDefault(_FontDescriptor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var RunStyle = function RunStyle() {
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  _classCallCheck(this, RunStyle);

  this.color = attributes.color || 'black';
  this.backgroundColor = attributes.backgroundColor || null;
  this.fontDescriptor = _FontDescriptor2.default.fromAttributes(attributes);
