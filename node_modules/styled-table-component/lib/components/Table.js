...
var tableDarkDark = function tableDarkDark(props) {
  return props.tableDark && (0, _styledComponents.css)(_templateObject10, tableDarkDarkBordered, tableDarkDarkStriped, tableDarkDarkHover);
};
...
var tableResponsiveSmall = function tableResponsiveSmall(props) {
  return props.responsiveSm && (0, _styledComponents.css)(_templateObject11, tableResponsiveBordered);
};

var tableResponsiveMedium = function tableResponsiveMedium(props) {
  return props.responsiveMd && (0, _styledComponents.css)(_templateObject12, tableResponsiveBordered);
};

var tableResponsiveLarge = function tableResponsiveLarge(props) {
  return props.responsiveLg && (0, _styledComponents.css)(_templateObject13, tableResponsiveBordered);
};

var tableResponsiveXLarge = function tableResponsiveXLarge(props) {
  return props.responsiveXl && (0, _styledComponents.css)(_templateObject14, tableResponsiveBordered);
};

var tableResponsive = function tableResponsive(props) {
  return props.responsive && (0, _styledComponents.css)(_templateObject15, tableResponsiveBordered);
};

var Table = exports.Table = (0, _styledComponents2.default)(_styledBaseComponents.Table)(_templateObject16, tableSmall, tableBordered, tableStriped, tableHover, tableDarkDark, tableHeadDark, tableHeadLight, tableResponsiveSmall, tableResponsiveMedium, tableResponsiveLarge, tableResponsiveXLarge, tableResponsive, _styledSystem.space, _styledSystem.width, _styledSystem.color, _styledSystem.fontSize, _styledSystem.fontWeight, _styledSystem.textAlign, _styledSystem.lineHeight, _styledSystem.display, _styledSystem.borderRadius, _styledSystem.borderColor, _styledSystem.borders);