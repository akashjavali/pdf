...
var tablePrimary = exports.tablePrimary = function tablePrimary(props) {
  return props.primary && (0, _styledComponents.css)(_templateObject2, tablePrimaryHover);
};
...
var tableSecondary = exports.tableSecondary = function tableSecondary(props) {
  return props.secondary && (0, _styledComponents.css)(_templateObject4, tableSecondaryHover);
};
...
var tableSuccess = exports.tableSuccess = function tableSuccess(props) {
  return props.success && (0, _styledComponents.css)(_templateObject6, tableSuccessHover);
};
...
var tableInfo = exports.tableInfo = function tableInfo(props) {
  return props.info && (0, _styledComponents.css)(_templateObject8, tableInfoHover);
};
...
var tableWarning = exports.tableWarning = function tableWarning(props) {
  return props.warning && (0, _styledComponents.css)(_templateObject10, tableWarningHover);
};
...
var tableDanger = exports.tableDanger = function tableDanger(props) {
  return props.danger && (0, _styledComponents.css)(_templateObject12, tableDangerHover);
};
...
var tableLight = exports.tableLight = function tableLight(props) {
  return props.light && (0, _styledComponents.css)(_templateObject14, tableLightHover);
};
...
var tableDark = exports.tableDark = function tableDark(props) {
  return props.dark && (0, _styledComponents.css)(_templateObject16, tableDarkHover);
};
...
var tableActive = exports.tableActive = function tableActive(props) {
  return props.active && (0, _styledComponents.css)(_templateObject18, tableActiveHover);
};

var Tr = exports.Tr = _styledComponents2.default.tr(_templateObject19, tablePrimary, tableSecondary, tableSuccess, tableInfo, tableWarning, tableDanger, tableLight, tableDark, tableActive, _styledSystem.space, _styledSystem.width, _styledSystem.color, _styledSystem.fontSize, _styledSystem.fontWeight, _styledSystem.textAlign, _styledSystem.lineHeight, _styledSystem.display, _styledSystem.borderRadius, _styledSystem.borderColor, _styledSystem.borders);